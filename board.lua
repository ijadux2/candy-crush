	...
	for y = 1, self.height do
		for x = 1, self.width - 2 do
			if self.grid[y][x] and self.grid[y][x + 1] and self.grid[y][x + 2] then
				if
					self.grid[y][x].type == self.grid[y][x + 1].type
					and self.grid[y][x].type == self.grid[y][x + 2].type
				then
					...
					while
						extendX <= self.width
						and self.grid[y][extendX]
						and self.grid[y][extendX].type == self.grid[y][x].type
					do
	...
	for x = 1, self.width do
		for y = 1, self.height - 2 do
			if self.grid[y][x] and self.grid[y + 1][x] and self.grid[y + 2][x] then
				if
					self.grid[y][x].type == self.grid[y + 1][x].type
					and self.grid[y][x].type == self.grid[y + 2][x].type
				then
					...
					while
						extendY <= self.height
						and self.grid[extendY][x]
						and self.grid[extendY][x].type == self.grid[y][x].type
					do
						match.length = match.length + 1
						extendY = extendY + 1
					end
